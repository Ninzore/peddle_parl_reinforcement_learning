...
for i in range(1000):
    ...
    if i % 10 == 0:
        logger.info("Train Episode {}, Reward Sum {}.".format(i+1000*j, sum(reward_list)))
    ...
    if (i + 1) % 100 == 0:
        ...
        logger.info('Episode {}, Test reward: {}'.format(i + 1 + 1000*j, total_reward))
    
agent.save('./model{}k.ckpt'.format(j + 1))
